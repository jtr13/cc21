...
```{r}
# Load the shape file 
base_url <- "https://raw.githubusercontent.com/kennylee15/leaflet_for_r_101/main/tl_2020_36061_roads/tl_2020_36061_roads.shp"
download.file(URLencode(base_url), "tl_2020_36061_roads.shp", quiet=TRUE)

road_shape_ny <- readOGR("tl_2020_36061_roads", verbose = F)
leaflet() %>%
