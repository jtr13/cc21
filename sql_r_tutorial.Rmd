...
```
# 1. Creating a MySQL database in AWS
...
## 1.2 Create Relational DataBase instance in AWS
...
## 1.4 Populate the database with data!
...
## 2.2 Create - Read - Update - Delete operations
